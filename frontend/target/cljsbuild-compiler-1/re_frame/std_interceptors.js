...
var vec__13388_13391 = clojure.data.diff(orig_db,new_db);
var only_before_13392 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13388_13391,(0),null);
var only_after_13393 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13388_13391,(1),null);
var db_changed_QMARK__13394 = (cljs.core.some_QMARK_(only_before_13392)) || (cljs.core.some_QMARK_(only_after_13393));
if(db_changed_QMARK__13394){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only before: ",only_before_13392], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only after : ",only_after_13393], 0));
...
var map__13401 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
var map__13401__$1 = ((((!((map__13401 == null)))?((((map__13401.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13401.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13401):map__13401);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13401__$1,cljs.core.cst$kw$db);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13401__$1,cljs.core.cst$kw$event);
...
var map__13409 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
var map__13409__$1 = ((((!((map__13409 == null)))?((((map__13409.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13409.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13409):map__13409);
var coeffects = map__13409__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13409__$1,cljs.core.cst$kw$event);
...
var len__7326__auto___13412 = arguments.length;
var i__7327__auto___13413 = (0);
while(true){
if((i__7327__auto___13413 < len__7326__auto___13412)){
args__7333__auto__.push((arguments[i__7327__auto___13413]));

var G__13414 = (i__7327__auto___13413 + (1));
i__7327__auto___13413 = G__13414;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__7334__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq13411){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13411));
});
...
var args__7333__auto__ = [];
var len__7326__auto___13420 = arguments.length;
var i__7327__auto___13421 = (0);
while(true){
if((i__7327__auto___13421 < len__7326__auto___13420)){
args__7333__auto__.push((arguments[i__7327__auto___13421]));

var G__13422 = (i__7327__auto___13421 + (1));
i__7327__auto___13421 = G__13422;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7334__auto__);
});
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__13415_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__13416_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__13416_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq13417){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__13418,G__13419,seq13417__$2);
});
