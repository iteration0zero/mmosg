...
if((i < len)){
var k = (ks[i]);
var G__12551 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12552 = (i + (1));
m = G__12551;
i = G__12552;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12556 = c;
var G__12556__$1 = (((G__12556 == null))?null:G__12556.prototype);
if((G__12556__$1 == null)){
return null;
} else {
return (G__12556__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12560 = c;
var G__12560__$1 = (((G__12560 == null))?null:G__12560.prototype);
if((G__12560__$1 == null)){
return null;
} else {
return (G__12560__$1["render"]);
}
})()));
});
...
var G__12564 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12564) : reagent.impl.component.as_element.call(null,G__12564));
};
...
var _STAR_current_component_STAR_12571 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12571;
}});
...
var G__12579 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12579) {
...
return ((function (G__12579){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12582 = reagent.impl.component.state_atom(c);
var G__12583 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12582,G__12583) : cljs.core.reset_BANG_.call(null,G__12582,G__12583));
});
;})(G__12579))
...
var or__6251__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__12585_12587 = (c["cljsRatom"]);
if((G__12585_12587 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12585_12587);
}
...
if(cljs.core.truth_((function (){var and__6239__auto__ = wrap;
...
var renders_12590 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12591 = cljs.core.first(cljs.core.vals(renders_12590));
if((cljs.core.count(renders_12590) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12590))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12591)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12591], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6251__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6251__auto__)){
return or__6251__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6251__auto__ = render_fun;
if(cljs.core.truth_(or__6251__auto__)){
return or__6251__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6251__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6251__auto__)){
return or__6251__auto__;
} else {
...
var name__$1 = (function (){var G__12589 = name;
switch (G__12589) {
case "":
...
var elem = (function (){var G__12600 = (function (){var or__6251__auto__ = (function (){var G__12602 = c;
if((G__12602 == null)){
return null;
} else {
return (G__12602["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6251__auto__)){
return or__6251__auto__;
...
return (G__12600["_currentElement"]);
}
})();
var name = (function (){var G__12603 = elem;
var G__12603__$1 = (((G__12603 == null))?null:(G__12603["type"]));
if((G__12603__$1 == null)){
return null;
} else {
return (G__12603__$1["displayName"]);
}
})();
var path = (function (){var G__12604 = elem;
var G__12604__$1 = (((G__12604 == null))?null:(G__12604["_owner"]));
var G__12604__$2 = (((G__12604__$1 == null))?null:reagent$impl$component$component_path(G__12604__$1));
if((G__12604__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12604__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6251__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6251__auto__)){
return or__6251__auto__;
} else {
var G__12606 = c;
var G__12606__$1 = (((G__12606 == null))?null:G__12606.constructor);
if((G__12606__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12606__$1);
}
}
})();
