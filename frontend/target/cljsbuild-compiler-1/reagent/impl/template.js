...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6857__auto__,writer__6858__auto__,opt__6859__auto__){
return cljs.core._write(writer__6858__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12636 = o;
(G__12636[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12637__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__12637 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__12638__i = 0, G__12638__a = new Array(arguments.length -  0);
while (G__12638__i < G__12638__a.length) {G__12638__a[G__12638__i] = arguments[G__12638__i + 0]; ++G__12638__i;}
  args = new cljs.core.IndexedSeq(G__12638__a,0);
} 
return G__12637__delegate.call(this,args);};
G__12637.cljs$lang$maxFixedArity = 0;
G__12637.cljs$lang$applyTo = (function (arglist__12639){
var args = cljs.core.seq(arglist__12639);
return G__12637__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__6239__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6239__auto__){
var and__6239__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__6239__auto____$1){
var and__6239__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__6239__auto____$2)){
...
var G__12644 = jsprops;
(G__12644["defaultValue"] = value);

(G__12644["onChange"] = ((function (G__12644,v,value,on_change){
return (function (p1__12642_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12642_SHARP_);
});})(G__12644,v,value,on_change))
);
...
var vec__12651 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12651,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12651,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12651,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12656 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12656 == null)){
} else {
var key_12657 = temp__4661__auto___12656;
(jsprops["key"] = key_12657);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12659 = (new reagent.impl.template.NativeWrapper());
(G__12659["name"] = c);
...
var G__12661 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12661) : reagent.impl.template.as_element.call(null,G__12661));
} else {
...
var len__7326__auto___12667 = arguments.length;
var i__7327__auto___12668 = (0);
while(true){
if((i__7327__auto___12668 < len__7326__auto___12667)){
args__7333__auto__.push((arguments[i__7327__auto___12668]));

var G__12669 = (i__7327__auto___12668 + (1));
i__7327__auto___12668 = G__12669;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7334__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12665){
var G__12666 = cljs.core.first(seq12665);
var seq12665__$1 = cljs.core.next(seq12665);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12666,seq12665__$1);
});
...
break;
default:
var G__12673 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12673;
continue;
...
var n__7166__auto___12676 = a.length;
var i_12677 = (0);
while(true){
if((i_12677 < n__7166__auto___12676)){
(a[i_12677] = reagent.impl.template.as_element((a[i_12677])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7166__auto___12679 = a.length;
var i_12680 = (0);
while(true){
if((i_12680 < n__7166__auto___12679)){
var val_12681 = (a[i_12680]);
if((cljs.core.vector_QMARK_(val_12681)) && ((reagent.impl.template.key_from_vec(val_12681) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12680] = reagent.impl.template.as_element(val_12681));

var G__12682 = (i_12680 + (1));
i_12680 = G__12682;
continue;
} else {
}
...
var ctx = {};
var vec__12686 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12686,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12686,(1),null);
...
var G__12690 = (cljs.core.count(argv) - first_child);
switch (G__12690) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12690){
